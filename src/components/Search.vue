  ...
  <div>
    ...
    <div class="search-wrapper" data-search-type="movie">
      <div class="search-header">
        <div class="input-wrapper">
          <img
            ...
            alt
          />
          <input v-model="keyword" class="search-input" type="text" placeholder="搜电影、搜影院" />
          <img
            class="del-input"
            style="display: none;"
      ...
      <div class="search-history" style>
        <div v-for="(item,index) in keywordList" :key="index"  class="history-item" >
          <span class="history-icon"></span>
          <span class="word one-line">{{item}}</span>
          <div @click="delWord(index)" class="del-word"></div>
        </div>
      </div>
