<template>
  <div class="item-container"  >
    <div class="photo">
      <!-- http://p0.meituan.net/w.h/moviemachine/58ee13be6dc60bf5e636cf915bbbaaa55787785.jpg -->
      <!-- https://p0.meituan.net/128.180/moviemachine/58ee13be6dc60bf5e636cf915bbbaaa55787785.jpg/ -->
    ...
    <div class="content">
      ...
      <div class="score">
        ...
        <span v-if="item.globalReleased" class="grade">
          <label >观众评</label>
          {{item.sc}}
          </span>
    ...
    <div class="btn-box">
      <div v-if="item.globalReleased" class="btn" >购票</div>
      <div v-else class="presell" >预售</div>
    </div>
...
export default {
  props: ["item"],
  filters: {
    ImgFilter: function(src) {
      return src.replace("w.h", "128.180");
    }
  },
